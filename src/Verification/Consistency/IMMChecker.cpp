...
std::vector<Event> IMMChecker::getInitRfsAtLoc(const ExecutionGraph &g, SAddr addr)
{
...
ExecutionGraph::const_co_iterator IMMChecker::splitLocMOBefore(const ExecutionGraph &g, SAddr addr,
							       Event e)
{
...
ExecutionGraph::const_co_iterator IMMChecker::splitLocMOAfterHb(const ExecutionGraph &g, SAddr addr,
								const Event read)
{
...
ExecutionGraph::const_co_iterator IMMChecker::splitLocMOAfter(const ExecutionGraph &g, SAddr addr,
							      const Event e)
{
...
std::vector<Event> IMMChecker::getCoherentStores(const ExecutionGraph &g, SAddr addr, Event read)
{
...
std::vector<Event> IMMChecker::getMOOptRfAfter(const ExecutionGraph &g, const WriteLabel *sLab)
{
...
std::vector<Event> IMMChecker::getMOInvOptRfAfter(const ExecutionGraph &g, const WriteLabel *sLab)
{
	std::vector<Event> after;
	std::vector<const ReadLabel *> rfAfter;
...
std::vector<Event> IMMChecker::getCoherentRevisits(const ExecutionGraph &g, const WriteLabel *sLab,
...
std::vector<Event> IMMChecker::getCoherentPlacings(const ExecutionGraph &g, SAddr addr, Event store,
						   bool isRMW)
{
	std::vector<Event> result;
