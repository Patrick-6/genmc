...
const std::unordered_map<std::string, InternalFunctions> internalFunNames = {
	...
	{"__VERIFIER_cond_init", InternalFunctions::FN_CondVarInit},
	{"__VERIFIER_cond_wait", InternalFunctions::FN_CondVarWait},
	{"__VERIFIER_cond_signal", InternalFunctions::FN_CondVarSignal},
	{"__VERIFIER_cond_broadcast", InternalFunctions::FN_CondVarBcast},
	{"__VERIFIER_cond_destroy", InternalFunctions::FN_CondVarDestroy},
